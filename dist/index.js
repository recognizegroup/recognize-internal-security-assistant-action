...
const rules = __importStar(__nccwpck_require__(8547));
function check(url) {
...
function run() {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            yield check_1.check('https://recognize.nl');
        }
        catch (error) {
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
__exportStar(__nccwpck_require__(8547), exports);
